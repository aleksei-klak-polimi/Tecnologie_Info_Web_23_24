...
public class CommentDAO {
	...
	public List<Comment> getCommentsByPicture(int pictureId) throws SQLException {
		...
		String query ="SELECT C.id, C.body, C.pictureId, C.postDate, U.username FROM Comment C JOIN User U ON C.author = U.id WHERE pictureId = ? ORDER BY C.postDate ASC, C.id ASC";
